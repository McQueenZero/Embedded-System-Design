...
//显示16x32数字
void Put_number16x32(unsigned short x, unsigned short  y, unsigned char value, unsigned int fColor,unsigned int bColor)
...
void Put1616(unsigned short x, unsigned short  y, unsigned char c[2], unsigned int fColor,unsigned int bColor)
 {
	...
	for (k=0;k<160;k++)      //64标示自建汉字库中的个数160，循环查询内码
	{ 
